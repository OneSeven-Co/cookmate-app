...
/**
 * ViewModel for handling home screen recipe operations
...
class HomeViewModel(
     ...
     * @param category The category to load recipes for
     */
    fun loadRecipesByCategory(category: String) {
        viewModelScope.launch {
            recipeRepository.getRecipesByCategory(category).collect { result ->
                _recipes.value = result
            }
        }
    }
